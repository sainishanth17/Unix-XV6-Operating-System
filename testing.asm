...
int main(void) {
 ...
 for (i = 0; i < 4; i++) {
   ...
   if (fork()  == 0) { 
   f:	e8 56 02 00 00       	call   26a <fork>
  14:	85 c0                	test   %eax,%eax
  16:	75 20                	jne    38 <main+0x38>

     printf(1,"foo\n"); 
  18:	c7 44 24 04 46 07 00 	movl   $0x746,0x4(%esp)
  1f:	00 
...
return 0;
  ...
  37:	c3                   	ret    
     ...
     wait ();
  38:	e8 3d 02 00 00       	call   27a <wait>

     exit();
  3d:	e8 30 02 00 00       	call   272 <exit>
  42:	66 90                	xchg   %ax,%ax
  44:	66 90                	xchg   %ax,%ax
  46:	66 90                	xchg   %ax,%ax
  48:	66 90                	xchg   %ax,%ax
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 379:	0f b6 92 52 07 00 00 	movzbl 0x752(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 50f:	8b 38                	mov    (%eax),%edi
        ...
        if(s == 0)
          s = "(null)";
 511:	b8 4b 07 00 00       	mov    $0x74b,%eax
