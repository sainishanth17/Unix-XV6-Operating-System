...
int main(int argc, char *argv[]) {
  ...
  12:	7f 19                	jg     2d <main+0x2d>
        printf(2,"Usage: nice pid priority\n");
  14:	c7 44 24 04 18 08 00 	movl   $0x818,0x4(%esp)
  1b:	00 
  1c:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
  23:	e8 88 04 00 00       	call   4b0 <printf>
        exit();
  28:	e8 15 03 00 00       	call   342 <exit>
    }
    pid = atoi(argv[1]);
  2d:	8b 43 04             	mov    0x4(%ebx),%eax
  30:	89 04 24             	mov    %eax,(%esp)
  33:	e8 a8 02 00 00       	call   2e0 <atoi>
  38:	89 c6                	mov    %eax,%esi
    priority = custom_strtol(argv[2]);
  3a:	8b 43 08             	mov    0x8(%ebx),%eax
  3d:	89 04 24             	mov    %eax,(%esp)
  40:	e8 6b 00 00 00       	call   b0 <custom_strtol>

    printf(1, "Priority: %d\n", priority);
  45:	c7 44 24 04 32 08 00 	movl   $0x832,0x4(%esp)
  4c:	00 
  ...
  5f:	8d 43 14             	lea    0x14(%ebx),%eax
  62:	83 f8 27             	cmp    $0x27,%eax
  65:	77 16                	ja     7d <main+0x7d>
  ...
  67:	89 5c 24 04          	mov    %ebx,0x4(%esp)
  6b:	89 34 24             	mov    %esi,(%esp)
  6e:	e8 77 03 00 00       	call   3ea <chpr>
    if (result == -1) {
  73:	83 c0 01             	add    $0x1,%eax
  76:	74 1e                	je     96 <main+0x96>
  ...
  78:	e8 c5 02 00 00       	call   342 <exit>
    ...
    if (priority < -20 || priority > 19) {
        printf(2, "Invalid priority range, range should only be within (-20-19)!\n");
  7d:	c7 44 24 04 5c 08 00 	movl   $0x85c,0x4(%esp)
  84:	00 
  ...
  91:	e8 ac 02 00 00       	call   342 <exit>
    ...
    if (result == -1) {
        printf(2, "Failed to set priority.\n");
  96:	c7 44 24 04 40 08 00 	movl   $0x840,0x4(%esp)
  9d:	00 
  9e:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
  a5:	e8 06 04 00 00       	call   4b0 <printf>
  aa:	eb cc                	jmp    78 <main+0x78>
  ac:	66 90                	xchg   %ax,%ax
  ae:	66 90                	xchg   %ax,%ax
...
long custom_strtol(const char *str) {
  ...
  cd:	8d 7c 1b ff          	lea    -0x1(%ebx,%ebx,1),%edi
    ...
    for (; str[i] != '\0'; i++) {
  d1:	84 d2                	test   %dl,%dl
  d3:	74 3b                	je     110 <custom_strtol+0x60>
        if (str[i] >= '0' && str[i] <= '9') {
...
free(void *ap)
{
 ...
 6e7:	89 10                	mov    %edx,(%eax)
  freep = p;
 6e9:	a3 58 0b 00 00       	mov    %eax,0xb58
}
 6ee:	5b                   	pop    %ebx
 6ef:	5e                   	pop    %esi
 6f0:	5f                   	pop    %edi
 ...
 70f:	03 4b fc             	add    -0x4(%ebx),%ecx
    ...
    p->s.ptr = bp;
  freep = p;
 712:	a3 58 0b 00 00       	mov    %eax,0xb58
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 739:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 73c:	8b 1d 58 0b 00 00    	mov    0xb58,%ebx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
...
morecore(uint nu)
{
 ...
 779:	89 c2                	mov    %eax,%edx
    ...
    if(p == freep)
 77b:	3b 15 58 0b 00 00    	cmp    0xb58,%edx
...
morecore(uint nu)
{
 ...
 7ad:	e8 ee fe ff ff       	call   6a0 <free>
  return freep;
 7b2:	8b 15 58 0b 00 00    	mov    0xb58,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 7ec:	eb e9                	jmp    7d7 <malloc+0xa7>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 7ee:	c7 05 58 0b 00 00 5c 	movl   $0xb5c,0xb58
 7f5:	0b 00 00 
    base.s.size = 0;
 7f8:	ba 5c 0b 00 00       	mov    $0xb5c,%edx
  Header *p, *prevp;
  uint nunits;
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 7fd:	c7 05 5c 0b 00 00 5c 	movl   $0xb5c,0xb5c
 804:	0b 00 00 
    base.s.size = 0;
 807:	c7 05 60 0b 00 00 00 	movl   $0x0,0xb60
 80e:	00 00 00 
